...
cover: 'https://ucarecdn.com/603c6377-b313-4b3b-92f6-983662714d47/'
date: '2019-09-29'
editorial: publisher
authors:
...
featured: false
headline: >-
  Gmail là dịch vụ mail miễn phí cực phổ biến mà đa số mọi người dùng, với dung
  lượng miễn phí cực lớn dao động từ 15GB đến 17GB thời invite giới thiệu được
  tặng thêm 2GB.
---
...
Bản thân <mark>vanmay.info</mark> sử dụng dịch vụ Gmail của Google để tăng sức mạnh cho giao tiếp email tên miền tùy chỉnh của mình. Gmail cung cấp một tính năng độc đáo thông qua đó tôi có thể thêm nhiều địa chỉ tên miền tùy chỉnh ngay trong tài khoản Gmail của mình. 
...
<sub><sub>xem mẫu của vanmay.info</sub></sub>

![Mẫu mx record của ramendaily.com](https://data.ramendaily.com/assets/img/images/og-images/gmail/dns_mx.png)
...
![Form nhập tên miền và email bạn dùng gmail](https://data.ramendaily.com/assets/img/images/og-images/gmail/add_domain.png)
...
![Xác minh 2 bước phải được bật](https://data.ramendaily.com/assets/img/images/og-images/gmail/xacminh2buoc.png)

_xác minh 2 bước phải được bật_

![Tạo mật khẩu ứng dụng](https://data.ramendaily.com/assets/img/images/og-images/gmail/apppassword.png)
...
![thêm mail tên miền vào gmail](https://data.ramendaily.com/assets/img/images/og-images/gmail/gmail1.png)

_thêm mail tên miền vào gmail_

![Gõ mật khẩu ứng dụng vào cấu hình smtp](https://data.ramendaily.com/assets/img/images/og-images/gmail/gmail2.png)
